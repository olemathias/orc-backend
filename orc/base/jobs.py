...
def create_instance_job(instance_id):
    ...
    if platform.dns_forward_provider_config is not None and platform.dns_forward_provider_config['type'] == 'pdns':
    ...
    if platform.dns_reverse_provider_config is not None and platform.dns_reverse_provider_config['type'] == 'pdns':
    ...
    if platform.identity_management_provider_config is not None and platform.identity_management_provider_config['type'] == 'freeipa':
    ...
    # VM Provider
    if platform.vm_provider_config is not None and platform.vm_provider_config['type'] == 'pve':
...
def delete_instance_job(instance_id):
    ...
    # IPAM Provider
    if platform.ipam_provider_config is not None and platform.ipam_provider_config['type'] == 'netbox':
